...
var html =
  "<table><tr><td class='col1'><button type='submit' id='button1' onclick='function1()'>Column1</button></td><td class='col2'><button type='submit' id='button2' onclick='function2()'>Column2</button></td><td class='col3'><button type='submit' id='button3' onclick='function3()'>Column3</button></td><td class='col4'><button type='submit' id='button4' onclick='function4()'>Column4</button></td><td class='col5'><button type='submit' id='button5' onclick='function5()'>Column5</button></td></tr></table>";
